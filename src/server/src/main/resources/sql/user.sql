-- Default users
INSERT IGNORE INTO pos.user (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES
...
-- Authorities
INSERT IGNORE INTO authority (ID, NAME) VALUES
  (1, 'ROLE_USER'),
  (2, 'ROLE_ADMIN');

-- Assign authorities to default users
INSERT IGNORE INTO pos.user_authority (user_id, authority_id) VALUES
  (1, 1),
  (1, 2),
  (2, 1),
  (3, 1);